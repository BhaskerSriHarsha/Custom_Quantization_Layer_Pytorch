import torch
from base_model_def import QuantizedModel
from torchvision import datasets, transforms
from torch.utils.data import DataLoader

DEVICE = "cuda:0"

q_model = QuantizedModel().to(DEVICE)
q_model.load_state_dict(torch.load('quantized_model.pth', map_location=DEVICE, weights_only=True))
q_model.eval()
